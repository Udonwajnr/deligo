...
import { ArrowLeft, Minus, Navigation } from 'react-native-feather';
  ...
  return (
    <View className="bg-white flex-1">
            ...
            Object.entries(groupedItems).map(([key,items])=>{
                ...
                return(
                    <View key={key} className="flex-row items-center space-x-3 py-2 px-4 bg-white rounded-3xl mx-2 mb-3 shadow-lg">
                        ...
                        <TouchableOpacity onPress={()=>dispatch(removeFromCart({id:dish._id}))} className="p-1 rounded-full" style={{backgroundColor:themeColors.bgColor(1)}}>
        ...
        <View style={{backgroundColor:themeColors.bgColor(0.2)}} className="p-6 px-8 rounded-t-3xl space-y-4"> 
            ...
            >
                <Text className="text-white text-center font-bold text-lg text-black">Place Order</Text>
            </TouchableOpacity>
        </View>
    </View>
  )
